...
The robot needs to charge, it reaches the charging location, which si the 'E' corridor, and simulates a charging task by wasting time in that specific location.
